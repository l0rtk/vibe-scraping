...
def analyze_crawl_data(crawl_data_path="./crawl_data", output_path="./analysis_results.json"):
    """
    ...
    """
    analyzer = ContentAnalyzer(crawl_data_path)
...
if __name__ == "__main__":
    ...
    stats = analyze_crawl_data(args.input, args.output)
